...
const Login: React.FC = () => {
  ...
  const { user, login, signup, loginWithGoogle, loginWithMicrosoft, isLoading: authLoading } = useAuth();
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="w-full inline-flex justify-center py-2.5 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition-colors duration-200"
            >
